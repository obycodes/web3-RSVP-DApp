          ...
          <div className="flex flex-wrap md:flex-nowrap items-start w-full">
            ...
            <div className="grow-1 w-full">
              <div className="text-center md:text-left">
                ...
                <button onClick={connectWallet} type="button" className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-emerald-700 bg-emerald-100 hover:bg-emerald-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
                    Connect Wallet
                </button>
               )}
              </div>
